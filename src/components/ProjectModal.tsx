...
export function ProjectModal({ isOpen, onClose, categories, onSave }: ProjectModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (deadline) {
      ...
      const now = new Date();
      if (selectedDate < now) {
        showToast("Cannot set a project deadline in the past.", "error");
        return;
      }
      ...
      if (selectedDate > maxDate) {
        showToast("Cannot set a project deadline more than 10 years in the future.", "error");
        return;
      }
    }
        ...
        >
          ...
          >
            <div className="flex justify-between items-center px-6 py-5 border-b border-neutral-800 bg-neutral-900/50">
              <h2 className="text-xl font-serif tracking-tight text-white">New Project</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-6 overflow-y-auto max-h-[80vh]">
              <div className="space-y-4">
                ...
                <div>
                  <textarea 
                    ...
                    placeholder="Add details and goals..."
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 pl-1">Target Date</label>
                <input 
                  type="datetime-local" 
                  value={deadline}
